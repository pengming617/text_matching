...
class TrainModel(object):
    ...
    def pre_processing(self):
        ...
        data_pre.build_vocab(data, parent_path+'/save_model/paircnn' + '/vocab.pickle')
        # 加载词典
        self.vocab_processor = learn.preprocessing.VocabularyProcessor.restore(parent_path+'/save_model/paircnn' +
                                                                               '/vocab.pickle')
    ...
    def trainModel(self):
        ...
        # 定义训练用的循环神经网络模型
        with tf.variable_scope('paircnn_model', reuse=None):
            # paircnn_ranking
        ...
        with tf.Session() as sess:
            ...
            for time in range(con.epoch):
                ...
                if f1 > best_f1:
                    best_f1 = f1
                    saver.save(sess, parent_path + "/save_model/paircnn/model.ckpt")
